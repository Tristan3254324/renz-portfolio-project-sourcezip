...
export default function VideoWithControls() {
  ...
  // Export path: clean render, no controls, audio unmuted
  if (!isIframed) return <VideoTemplate />;

  return <IframedControls />;
}

// Separate component so hooks only run in the iframe path
function IframedControls() {
  const {
    sceneKeys,
    activeIndex,
    locked,
